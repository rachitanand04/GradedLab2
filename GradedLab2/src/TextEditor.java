...
public class TextEditor {
    ...
    public static void textEditor(JFrame frame){
        ...
        editor.add(textBox);
        editor.setPreferredSize(new Dimension(1000,795));
...
//        toolBar.add(new JButton("Right Aligned"));
        String[] toolBarIcons = {"bold","italic","strikethrough","underline","leftAlign","centerAlign","rightAlign","justify"};
        for(String item:toolBarIcons){
            toolBar.add(new JButton(new ImageIcon("Images/"+item+".png")));
        }
    ...
    public static void bottomBar(JFrame frame){
        ...
        bottomBar.setBorder(BorderFactory.createLineBorder(Color.GRAY));
